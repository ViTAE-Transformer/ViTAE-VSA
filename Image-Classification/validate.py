...
parser.add_argument('--throughputs', action='store_true', default=False)
try:
...
def main():
    ...
    if args.throughputs:
        ...
        get_throughputs(model, loader_eval, args)
        exit()
...
def get_throughputs(model, loader, args, amp_autocast=suppress, log_suffix=''):
    ...
    print(f'total time: {inference_time}, count: {count}, throughputs: {count/inference_time}imgs/s')
    pass
